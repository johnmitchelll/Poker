...
function mouseOverGraphDisplay(){
	...
	&& mouseY <= CANVAS_HEIGHT/10+CANVAS_HEIGHT/2){	
		...
		colorRect(CANVAS_WIDTH/8+mouseIndexPos*inputWidth-7.5, CANVAS_HEIGHT/10+25+vertexPercentDown*(CANVAS_HEIGHT/2-50)-7.5+5, 15, 15, "white");
		drawText("black", "24px customfont", sessionData[mouseIndexPos], CANVAS_WIDTH/8+mouseIndexPos*inputWidth+8, CANVAS_HEIGHT/10+25+vertexPercentDown*(CANVAS_HEIGHT/2-50)-8+5);
	}
}